...
<%@page	import="com.primeton.paas.console.common.monitor.MemoryInfo"%>
<%@page	import="com.primeton.paas.console.common.monitor.HostMonitorUtil"%>

<%
	long CEP_ONEMINUTESAGO = HostMonitorUtil.getCEP_ONEMINUTESAGO();
	String ip = request.getParameter("ip");
	String timeInterval = request.getParameter("timeInterval");
	int minutes = Integer.parseInt(request.getParameter("minutes"));
	MemoryInfo obj = HostMonitorUtil.getMemoryMonitorInfo(ip, minutes);
	String usedStr = "";
	String timeStr = "";
	if (obj != null && obj instanceof MemoryInfo) {
		MemoryInfo info = (MemoryInfo) obj;
	...
	<script type="text/javascript">
		...
		AmCharts.ready(function() {
		   ...
		   chart = new AmCharts.AmSerialChart();
            ...
            valueAxis.title = "Memory Monitor Data";
			valueAxis.minimum = 0;
		    ...
		    chartCursor.cursorColor = "#8B12AE";
		    ...
		    setInterval(function () {
				...
				/**begin */
	    		$.ajax({
    				url: "<%=request.getContextPath() %>/srv/monitor/getHostMemoryInfo",
                    data: { ip:ip,timeInterval:timeInterval},
                    async: false,
                    type: "post",
...
<body>
    ...
    <div style="margin-left:10px">
    	Memory 当前利用率:<span id="using" style="color: #8B12AE;width:15px">0</span>%&nbsp;&nbsp;&nbsp;<span style="color: #8B12AE;">*注：Y坐标轴表示Memory使用率，数值在0-100范围内</span>
    </div>
</body>
</html>