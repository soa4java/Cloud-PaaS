...
<body>
	...
	<script type="text/javascript">
		...
		function init() {
    		...
    		cpuFrame.src="showHostCPUInfo.jsp?ip="+ip+"&timeInterval="+timeInterval+"&minutes="+minutes;
    		memFrame.src="showHostMemoryInfo.jsp?ip="+ip+"&timeInterval="+timeInterval+"&minutes="+minutes;
    		loadAverageFrame.src="showHostOneLoadAverageInfo.jsp?ip="+ip+"&timeInterval="+timeInterval+"&minutes="+minutes;
    		ioFrame.src="showHostIOInfo.jsp?ip="+ip+"&timeInterval="+timeInterval+"&minutes="+minutes;
		}
	</script>
</body>
</html>
