...
<body>
    ...
    <fieldset id="HaProxy_field" style="width:97%;border:solid 1px #aaa;margin-top:8px;position:relative;display:none">
        ...
        <div style="width:100%;height:180px;margin-top:10px;" id="HaProxy_Monitor_INF_Frame" >
    ...
    <fieldset id="Memcached_field" style="width:97%;border:solid 1px #aaa;margin-top:8px;position:relative;display:none">
        ...
        <div style="width:100%;height:180px;margin-top:10px;" id="Memcached_Monitor_INF_Frame" >
    ...
    <fieldset id="MySQL_field" style="width:97%;border:solid 1px #aaa;margin-top:8px;position:relative;display:none">
        ...
        <div style="width:100%;height:180px;margin-top:10px;" id="MySQL_Monitor_INF_Frame" >
    ...
    <fieldset id="Jetty_field" style="width:97%;border:solid 1px #aaa;margin-top:8px;position:relative;display:none">
        ...
        <div style="width:100%;height:180px;margin-top:10px;" id="Jetty_Monitor_INF_Frame" >
    ...
    <fieldset id="UPJAS_field" style="width:97%;border:solid 1px #aaa;margin-top:8px;position:relative;display:none">
        <legend>UPJAS服务</legend>
        <div style="width:100%;height:180px;margin-top:10px;" id="UPJAS_Monitor_INF_Frame" >
	   		<iframe name="UPJAS" id="UPJAS" src="" width="100%" height="100%" frameborder="no" border="1" marginwidth="0" marginheight="0" scrolling="no"></iframe>
		</div>
    </fieldset>
    ...
    <script type="text/javascript">        
    	...
    	var upjasField = document.getElementById("UPJAS_field");
        ...
        function selectDisplay(data, appName) {
        	haproxyEnable = data.HaProxy;
     		...
     		if (memEnable) {
     			memClusterId = data.JettyClusterId;
     		...
     		if (mysqlEnable) {
     			mysqlClusterId = data.JettyClusterId;
