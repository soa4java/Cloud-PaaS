...
<%@page import="com.primeton.paas.manage.api.service.CollectorService"%>
...
<%
	...
	String rootPath = SystemVariables.getWorkspaceHome() + "/application";
%>
...
<body>         
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/service/createCep">
       	<fieldset style="border:solid 1px #aaa;padding:3px;">
            <legend >新增Collector服务向导</legend>
            <div style="padding:5px;">
            	<input name="order.itemList[0].itemType" value="<%=OrderItem.ITEM_TYPE_COLLECTOR %>" class="nui-hidden" />
		        <table border="0">
		            <tr>
		            ...
		            <tr>
	                    ...
	                    <td style="width:50%;">    
	                    	 ...
	                    	 <input name="order.itemList[0].attrList[2].attrValue"  class="nui-textbox" onvalidation="onNullValidation" value="<%=CollectorService.TYPE %>-default" width="90%"/>
	                    </td>
		            ...
		            <tr>
	                    ...
	                    <td style="width:50%;">    
	                    	 ...
	                    	 <input name="order.itemList[0].attrList[5].attrValue" id="mqServerName" class="nui-textbox" value="PAAS.LOG.MQServer" width="90%"/>
	                    </td>
		            ...
		            <tr>
	                    ...
	                    <td style="width:50%;">    
	                    	 ...
	                    	 <table id="mqdests" style="width:90%" border="0">
		                       <tr style="width:90%%">
		                       	   <td width="42%">名称： <input type="text" name="mqDest0" id="mqDest0" value=""  style="width:60%"/></td>
		            ...
		            <tr>
	                    ...
	                    <td style="width:50%;">    
	                    	 ...
	                    	 <input name="order.itemList[0].attrList[8].attrValue"  class="nui-textbox" vtype="range:128,4096" value="128" rangeErrorText="数字必须在128~4096之间" onvalidation="onNullValidation" width="90%"/>
	                    </td>
		            ...
		            <tr>
	                    <td style="width:15%;" align="right">日志目录：</td>
	                    <td style="width:50%;">    
	                         <input name="order.itemList[0].attrList[11].attrName" value="<%=OrderItemAttr.ATTR_COLLECTOR_LOG_ROOT%>" class="nui-hidden" />
	                    	 <input name="order.itemList[0].attrList[11].attrValue" class="nui-textbox" value="<%=rootPath %>" width="90%"/>
	                    </td>
	                    <td align="left">*存放收集应用日志的根目录</td>
	                </tr>
		        </table>            
            </div>
        </fieldset>
    ...
    <script type="text/javascript">        
    	...
    	function addMQServer(table_id) {
    		...
    		col2.innerHTML = "类型：<select name='mqType"+t_rownum+"' id='mqType"+t_rownum+"'><option value='queue'>queue</option><option value='exchange'>exchange</option></select></td>";
    		//col2.align = "right";
    	...
    	function doMqDestInfo() {
    	    ...
    	    for (var i=0; i<len; i++) {
    	    	...
    	    	if (mqType == "exchange") {
    	    		mqType = '<%=CollectorService.MQ_TYPE_EXCHANGE %>';
    	    	} else {
    	    		mqType = '<%=CollectorService.MQ_TYPE_QUEUE %>';
    	    	}
        ...
        function onAdd() {
        	...
        	if (!confirm("你确定要提交Collector服务创建申请？")) {
    	        return false;
    	    }
            ...
            $.ajax({
				url: "<%=request.getContextPath() %>/srv/service/createCollector",
