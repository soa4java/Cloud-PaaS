...
<body>
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/service/getSvnClusterDetail">
	...
	<div id="datagrid" class="nui-datagrid" style="width:100%;height:120px" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/svnService/<%=clusterId %>" showPager="false" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function initForm() {
        	...
        	$.ajax({
                url: "<%=request.getContextPath() %>/srv/service/getSvnClusterDetail/" + clusterId,
        ...
        function goBack() {
        	window.location = "svnClusterMgr.jsp";
        }
        ...
        function removeService(serviceId) {
        	...
        	$.ajax({
				url: "<%=request.getContextPath() %>/srv/service/removeSvnService/" + serviceId,
                success: function (text) {
                	nui.unmask();
                	var o = nui.decode(text);
                	if (o.result == true) { 
