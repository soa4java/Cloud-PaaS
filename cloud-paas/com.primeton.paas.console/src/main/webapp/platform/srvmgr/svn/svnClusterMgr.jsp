...
<body style="height:75%">         
   ...
   <div style="width:99%;">
    ...
    <div id="svnclustergrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/svnCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        var grid = nui.get("svnclustergrid");
        grid.load();
        ...
        function detailsRow(clusterId) {	
			window.location = "svnServiceMgr.jsp?clusterId=" + clusterId;
        }
		...
		function createCluster() {
			nui.open({
                url: bootPATH + "../../platform/srvmgr/svn/createSvn.jsp",
                title: "新增SVN服务向导", width: 800, height: 250,
                onload: function () {
                    //nothing
                },
