...
<body style="height:75%">         
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/mailCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function detailsRow(clusterId) {	
			window.location = "mailServiceMgr.jsp?clusterId=" + clusterId;
        }
		...
		function createCluster() {
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/mail/createMail.jsp",
                title: "新增Mail服务向导", width: 850, height: 500,
                onload: function () {
                    // nothing
                },
