...
<body>
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/service/getClusterDetail">
       	...
       	<fieldset style="border:solid 1px #aaa;padding:3px;">
            ...
            <div style="padding:5px;">
		        <table style="width:100%">
	                ...
	                <tr>
	                    <td style="width:10%;"  align="right">邮件转发线程数：</td>
	                    <td style="width:80%;">    
	                         <input name="attributes.maxMailWorkerNum" class="nui-textbox asLabel" width="100%"/>
	                    </td>
	                </tr>        
		        </table>            
            </div>
	...
	<div id="datagrid" class="nui-datagrid" style="width:100%;height:120px" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/mailService/<%=clusterId %>" showPager="false" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function initForm() {
        	...
        	$.ajax({
                url: "<%=request.getContextPath() %>/srv/service/getMailClusterDetail/" + clusterId,
        ...
        function goBack() {
        	window.location = "mailClusterMgr.jsp";
        }
        ...
        function removeService(serviceId) {
        	...
        	$.ajax({
				url: "<%=request.getContextPath() %>/srv/service/removeMailService/" + serviceId,
                success: function (text) {
                	nui.unmask();
                	var o = nui.decode(text);
                	if (o.result == true) { 
