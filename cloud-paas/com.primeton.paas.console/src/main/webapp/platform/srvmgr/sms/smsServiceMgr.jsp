...
<body>
       	...
       	<fieldset style="border:solid 1px #aaa;padding:3px;">
            ...
            <div style="padding:5px;">
		        <table style="width:100%">
                	...
                	<tr>
	                	<td style="width:10%;"  align="right">使用范围：</td>
	                    <td style="width:80%;">    
	                         <input name="scope" class="nui-combobox asLabel" data="[{ id:'inner', text: '平台服务' }, { id: 'outer', text: '外部服务'}]" value="inner" width="100%"/>
	                         <!-- <input name="scope" class="nui-combobox asLabel" textField="text" data="Genders" width="100%"/> -->
	                    </td>
                	</tr>  
		        </table>            
            </div>
	...
	<div id="smsservicegrid" class="nui-datagrid" style="width:100%;height:120px" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/smsService/<%=clusterId %>" showPager="false" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        var grid = nui.get("smsservicegrid");
        ...
        function initForm(){
        	...
        	$.ajax({
                url: "<%=request.getContextPath() %>/srv/service/getSmsClusterDetail/" + clusterId,
        ...
        function goBack() {
        	window.location = "smsClusterMgr.jsp";
        }
        ...
        function removeService(serviceId) {
        	...
        	$.ajax({
				url: "<%=request.getContextPath() %>/srv/service/removeSmsService/" + serviceId,
                success: function (text) {
                	nui.unmask();
                	var o = nui.decode(text);
                	if (o.result == true) { 
