...
<body style="height:75%">         
   ...
   <div style="width:99%;">
    ...
    <div id="smsclustergrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/smsCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        var grid = nui.get("smsclustergrid");
        grid.load();
        ...
        function detailsRow(clusterId) {	
			window.location="smsServiceMgr.jsp?clusterId=" + clusterId;
        }
		...
		function createCluster(){
			nui.open({
                url: bootPATH + "../../platform/srvmgr/sms/createSms.jsp",
                title: "新增短信服务向导", width: 800, height: 250,
                onload: function () {
                    //nothing
                },
