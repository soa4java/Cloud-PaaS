...
<body>         
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/service/createRedis">
    ...
    <script type="text/javascript">        
        ...
        function onAdd() {
            ...
            $.ajax({
				url: "<%=request.getContextPath() %>/srv/service/createRedis",
