...
<body style="height:80%">         
    ...
    <div id="clustergrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/redisCluster" showPager="true" onloaderror="onLoadErrorRenderer">
        <div property="columns">
            <!-- <div type="checkcolumn" ></div> -->        
            <div field="id" width="150" headerAlign="center" align ="center" allowSort="false" renderer="onActionRenderer">标识</div>    
            <div field="attributes.aliasName" width="100" headerAlign="center" align ="center">别名</div>
    ...
    <script type="text/javascript">        
		...
		function createCluster() {
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/redis/CreateService.jsp",
                title: "新增Redis服务向导", width: 800, height: 300,
                onload: function () {
                    //nothing
                },
