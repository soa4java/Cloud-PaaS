...
<body style="height:80%">         
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/jettyCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function onActionRenderer(e) {
            ...
            return '<a class="Edit_Button" href="javascript:detailsRow(\'' + clusterId + '\')">' + clusterId + '</a> ';
        }
        
        function detailsRow(clusterId) {	
			window.location = "jettyServiceMgr.jsp?clusterId=" + clusterId;
        }
