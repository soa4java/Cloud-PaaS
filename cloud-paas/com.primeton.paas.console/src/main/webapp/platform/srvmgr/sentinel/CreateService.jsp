...
<%@page import="com.primeton.paas.manage.api.service.RedisSentinelService"%>

<%
	String hostTemplatesJSON = SystemVariable.getHostTemplatesJSON();
	String redisSizeJSON = SystemVariable.getMaxRedisSizeJSON();
%>
...
<body>         
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/service/createRedisSentinel">
       	<fieldset style="border:solid 1px #aaa;padding:3px;">
            <legend >新增Redis哨兵服务向导</legend>
            <div style="padding:5px;">
            	<input name="order.itemList[0].itemType" value="<%=RedisSentinelService.TYPE %>" class="nui-hidden" />
            	<input name="order.orderType" value="CreateRedisSentinel" class="nui-hidden" /> <!-- 创建简单的Redis-Sentinel服务集群及其服务实例 -->
		        <table border="0">
		            <tr>
		            ...
		            <tr>
	                    ...
	                    <td style="width:50%;">    
	                    	 ...
	                    	 <input name="order.itemList[0].attrList[1].attrValue" class="nui-textbox" onvalidation="onNullValidation" value="<%=RedisSentinelService.TYPE %>-Service" width="80%"/>
	                    </td>
	                ...
	                <tr>
	                    ...
	                    <td style="width:50%;">    
	                    	 ...
	                    	 <input name="order.itemList[0].attrList[3].attrValue"  class="nui-combobox" data='<%=redisSizeJSON %>' value="1" width="80%"/>
	                    </td>
    ...
    <script type="text/javascript">        
        ...
        function onAdd() {
        	...
        	if (!confirm("你确定要提交Redis-Sentinel服务创建申请？")) {
    	        return false;
    	    }
            ...
            $.ajax({
				url: "<%=request.getContextPath() %>/srv/service/createRedisSentinel",
