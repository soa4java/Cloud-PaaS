    ...
    <fieldset style="width:97%;border:solid 1px #aaa;margin-top:8px;position:relative;">
        <div id="selForm" style="padding:0px;">
            <table style="width:100%;" border="0">
                <tr>
                	<td style="width:10%" align="right">标识:</td>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
						...
						<a class="nui-button" iconCls="icon-help" onclick="help()">关于</a>
                    </td>
                </tr>
            </table>           
        </div>
    </div>
    <div id="clustergrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/redisSentinelCluster" showPager="true" onloaderror="onLoadErrorRenderer">
        <div property="columns">
            <!-- <div type="checkcolumn" ></div> -->        
            <div field="id" width="150" headerAlign="center" align ="center" allowSort="false" renderer="onActionRenderer">标识</div>    
            <div field="name" width="150" headerAlign="center" align ="center" allowSort="false">显示名称</div>    
            <div field="attributes.size" width="100" headerAlign="center" align ="center" allowSort="false">实例数</div>    
            <div name="instsize" width="100" headerAlign="center" align="center" renderer="onInstSizeActionRenderer" cellStyle="padding:0;">实例数范围</div>
            <div field="attributes.status" width="100" headerAlign="center" align ="center" renderer="onServiceStateRenderer">状态</div>    
            <div field="owner" width="100" headerAlign="center" align ="center" allowSort="false">所有者</div>    
			<div name="action" width="300" headerAlign="center" align="center" renderer="onDoActionRenderer" cellStyle="padding:0;">操作</div>    
        </div>
  </div>
    <script type="text/javascript">        
        nui.parse();
        
        var grid = nui.get("clustergrid");
        grid.load();
        ...
        function detailsRow(clusterId) {	
			window.location="ServiceMgr.jsp?clusterId=" + clusterId;
        }
        ...
        function removeCluster(clusterId, type) {
        	...
        	$.ajax({
            	url : "<%=request.getContextPath() %>/srv/service/removeRedisSentinelService",
		...
		function createCluster() {
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/sentinel/CreateService.jsp",
                title: "新增Redis哨兵服务向导", width: 800, height: 350,
                onload: function () {
                    //nothing
                },
		...
		function help() {
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/sentinel/Help.jsp",
                title: "关于Redis哨兵服务", width: 600, height: 650,
                onload: function () {
                },
                ondestroy: function (action) {
                }
