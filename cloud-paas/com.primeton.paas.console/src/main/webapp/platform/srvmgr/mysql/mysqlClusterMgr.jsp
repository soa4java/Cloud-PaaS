...
<body style="height:80%">         
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/mysqlCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function detailsRow(clusterId) {	
			window.location = "mysqlServiceMgr.jsp?clusterId=" + clusterId;
        }
