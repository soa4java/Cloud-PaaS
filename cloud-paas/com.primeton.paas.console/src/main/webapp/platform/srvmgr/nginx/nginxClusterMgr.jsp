...
<body style="height:75%">         
   ...
   <div style="width:99%;">
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/nginxCluster" showPager="true" onloaderror="onLoadErrorRenderer">
        <div property="columns">
            ...
            <div field="attributes.vip" width="150" headerAlign="center" align ="center" allowSort="false">关联虚拟IP</div>
            <div field="attributes.size" width="50" headerAlign="center" align ="center" allowSort="false">实例数量</div>    
    ...
    <script type="text/javascript">        
        ...
        function detailsRow(clusterId) {	
			window.location = "nginxServiceMgr.jsp?clusterId=" + clusterId;
        }
		...
		function createCluster() {
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/nginx/createNginx.jsp",
                title: "新增Nginx服务向导", width: 870, height: 450,
                onload: function () {
                    // nothing
                },
