...
<body>
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/service/getJobCtrlClusterDetail">
	...
	<div id="servicegrid" class="nui-datagrid" style="width:100%;height:120px" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/jobCtrlService/<%=clusterId %>" showPager="false" onloaderror="onLoadErrorRenderer">
        <div property="columns">
            ...
            <div name="jobCtrl" width=50" headerAlign="center" align ="center" allowSort="false" renderer="onJobCtrlRenderer">JobCtrl</div>
            <div name="scheduler" width=50" headerAlign="center" align ="center" allowSort="false" renderer="onSchedulerRenderer">Scheduler</div>
    ...
    <script type="text/javascript">        
        ...
        function initForm() {
        	...
        	$.ajax({
                url: "<%=request.getContextPath() %>/srv/service/getJobCtrlClusterDetail/" + clusterId,
        ...
        function onSchedulerRenderer(e) {
	        var grid = e.sender;
	        var record = e.record;
	        return "<a target='_blank' href='http://" + record.ip + ":" + record.port + "/scheduler'>HTTP</a>";
        }
        
        function onJobCtrlRenderer(e) {
	        var grid = e.sender;
	        var record = e.record;
	        return "<a target='_blank' href='http://" + record.ip + ":" + record.port + "/primetonJobCtrl'>HTTP</a>";
        }
