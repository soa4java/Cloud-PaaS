...
<body style="height:80%">         
    ...
    <div style="width:99%;">
        <div class="nui-toolbar" style="border-bottom:0;padding:0px;">
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
						<a class="nui-button" iconCls="icon-add" onclick="newService()">新建</a>
                    </td>
                </tr>
            </table>           
        </div>
    ...
    <div id="clustergrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/jobCtrlCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function onDoActionRenderer(e) {
            ...
            if (state == 1) {
		   		return '<a href="javascript:detailsRow(\'' + clusterId + '\')">服务实例</a> '
		   			+ ' <a class="New_Button" href="javascript:removeCluster(\'' + clusterId +'\'' +','+'\''+type+ '\')">删除</a> ' 
        ...
        function newService() {
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/jobCtrl/CreateService.jsp",
                title: "新增JobCtrl服务向导", width: 900, height: 550,
                onload: function () {
                    //nothing
                },
