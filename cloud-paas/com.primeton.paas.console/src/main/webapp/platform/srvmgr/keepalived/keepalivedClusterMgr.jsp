...
<body style="height:80%">         
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/keepalivedCluster" showPager="true" onloaderror="onLoadErrorRenderer">
        <div property="columns">
            ...
            <div field="attributes.size" width="100" headerAlign="center" align ="center" allowSort="true">实例数量</div>    
    ...
    <script type="text/javascript">        
        ...
        function detailsRow(clusterId) {	
			window.location="keepalivedServiceMgr.jsp?clusterId=" + clusterId;
        }
