...
<%@page import="com.primeton.paas.manage.api.service.OpenAPIService"%>

<%
	String hostTemplatesJSON = SystemVariable.getHostTemplatesJSON();
	Object instNumsJSON = SystemVariable
			.getServiceInstNumJSON(OpenAPIService.TYPE);
%>
...
<body>         
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/service/createSms">
       	<fieldset style="border:solid 1px #aaa;padding:3px;">
            <legend >新增OpenAPI服务向导</legend>
            <div style="padding:5px;">
            	<input name="order.itemList[0].itemType" value="<%=OrderItem.ITEM_TYPE_OPENAPI %>" class="nui-hidden" />
		        <table border="0">
		            <tr>
		            ...
		            <tr>
	                    ...
	                    <td style="width:50%;">    
	                    	 ...
	                    	 <input name="order.itemList[0].attrList[1].attrValue" class="nui-textbox" onvalidation="onNullValidation" value="<%=OpenAPIService.TYPE %>-default" width="80%"/>
	                    </td>
    ...
    <script type="text/javascript">        
        ...
        function onAdd() {
        	if (!confirm("你确定要提交OpenAPI服务创建申请？")) {
    	        return false;
    	    }
        	form.validate();
            ...
            $.ajax({
				url: "<%=request.getContextPath() %>/srv/service/createOpenAPI",
