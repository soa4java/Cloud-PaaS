...
<body style="height:75%">         
   ...
   <div style="width:99%;">
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/openapiCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function detailsRow(clusterId) {	
			window.location = "openapiServiceMgr.jsp?clusterId=" + clusterId;
        }
        ...
        function onDoActionRenderer(e) {
            ...
            if (state == 1) {
		   		s = '<a href="javascript:detailsRow(\'' + clusterId + '\')">服务实例</a> ' 
		...
		function createCluster() {
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/openapi/createOpenAPI.jsp",
                title: "新增OpenAPI服务向导", width: 800, height: 250,
                onload: function () {
                    //nothing
                },
