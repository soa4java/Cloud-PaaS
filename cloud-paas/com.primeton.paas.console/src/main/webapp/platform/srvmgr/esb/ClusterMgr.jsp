...
<body style="height:80%">         
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/esbCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function newService() {
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/esb/CreateService.jsp",
                title: "新增ESB服务向导", width: 900, height: 550,
                onload: function () {
                    //nothing
                },
