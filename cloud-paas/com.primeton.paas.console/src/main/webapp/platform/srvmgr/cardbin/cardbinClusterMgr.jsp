...
<%@page import="com.primeton.paas.manage.api.model.IService" %>
   ...
   <div style="width:99%;">
        <div class="nui-toolbar" style="border-bottom:0;padding:0px;">
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
						<a class="nui-button" iconCls="icon-add" onclick="createCluster()">新建 <%=CardBinService.TYPE %> 服务</a>
                    </td>
                </tr>
            </table>           
        </div>
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/cardbinCluster" showPager="true" onloaderror="onLoadErrorRenderer">
        <div property="columns">
            <!-- <div type="checkcolumn" ></div> -->        
            <div field="id" width="150" headerAlign="center" align ="center" allowSort="false" renderer="onActionRenderer">集群标识</div>    
            <div field="name" width="100" headerAlign="center" align ="center" allowSort="false">显示名称</div>    
            <div field="attributes.size" width="100" headerAlign="center" align ="center" allowSort="false">实例数量</div>    
    ...
    <script type="text/javascript">        
        ...
        function detailsRow(clusterId) {	
			window.location = "cardbinServiceMgr.jsp?clusterId=" + clusterId;
        }
		...
		function createCluster(){
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/cardbin/createCardBin.jsp",
                title: "新增CardBin服务向导", width: 850, height: 620,
                onload: function () {
                    //nothing
                },
