...
<body>
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/service/getGatewayClusterDetail">
        ...
        <div class="nui-toolbar" style="border-bottom:0;padding:0px;">
            <table style="width:100%;">
                <tr>
                	<!-- 
                    <td style="width:100%;">
                    	<a class="nui-button" iconCls="icon-add" onclick="increase()">新增实例</a><span class="separator"></span>
						<a class="nui-button" iconCls="icon-remove" onclick="decrease()">移除实例</a>
                    </td>
                     -->
	...
	<div id="servicegrid" class="nui-datagrid" style="width:100%;height:120px" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/gatewayService/<%=clusterId %>" showPager="false" onloaderror="onLoadErrorRenderer">
        <div property="columns">
            ...
            <div field="ip" width="100" headerAlign="center" align ="center" allowSort="false">IP</div>    
            ...
            <div field="attributes.preServers" width="180" headerAlign="center" align ="center">前置服务</div>
            <div field="attributes.maxConnection" width="80" headerAlign="center" align ="center">最大连接数</div>        
    ...
    <script type="text/javascript">        
        ...
        function initForm() {
        	...
        	$.ajax({
                url: "<%=request.getContextPath() %>/srv/service/getGatewayClusterDetail/" + clusterId,
