...
<body style="height:75%">         
   ...
   <div style="width:99%;">
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/cepCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function detailsRow(clusterId) {	
			window.location = "cepEngineServiceMgr.jsp?clusterId=" + clusterId;
        }
		...
		function createCluster() {
			nui.open({
                url: "<%=request.getContextPath() %>/platform/srvmgr/cep/createCEPEngineService.jsp",
                title: "新增CEP服务向导", width: 850, height: 450,
                onload: function () {
                    //nothing
                },
