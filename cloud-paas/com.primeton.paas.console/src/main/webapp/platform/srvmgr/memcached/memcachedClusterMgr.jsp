...
<body style="height:80%">         
    ...
    <div id="datagrid" class="nui-datagrid" style="width:99%;height:100%" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/memcachedCluster" showPager="true" onloaderror="onLoadErrorRenderer">
    ...
    <script type="text/javascript">        
        ...
        function detailsRow(clusterId) {	
			window.location = "memcachedServiceMgr.jsp?clusterId=" + clusterId;
        }
        ...
        function onDoActionRenderer(e) {
            ...
            if (state == 1) {
            	return '<a href="javascript:detailsRow(\'' + clusterId + '\')">服务实例</a> ' 
		        	...
		        	+ ' <a class="Delete_Button" href="javascript:stopCluster(\'' + clusterId+'\'' +','+'\''+type+'\''+','+'\''+state+ '\')">停止</a> ';
		   	}
            return '<a href="javascript:detailsRow(\'' + clusterId + '\')">服务实例</a> ' 
            	+ ' <a href="javascript:removeCluster(\'' + clusterId +'\'' +','+'\''+type+ '\')">删除</a> ' 
