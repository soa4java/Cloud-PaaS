...
<body>
	...
	<div id="datagrid" class="nui-datagrid" style="width:100%;height:120px" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/memcachedService/<%=clusterId %>" showPager="false" onloaderror="onLoadErrorRenderer">
        <div property="columns">
            <!-- <div type="checkcolumn" ></div> -->        
            <div field="id" width="100" headerAlign="center" align ="center" allowSort="false" renderer="onActionRenderer">服务标识</div>    
            <div field="name" width="120" headerAlign="center" align ="center" allowSort="false">服务名称</div>    
            ...
            <div field="memorySize" width="80" headerAlign="center" align ="center" allowSort="false">内存大小</div>    
            <div field="maxConnectionSize" width="80" headerAlign="center" align ="center" allowSort="false">最大连接数</div> 
            <div field="createdDate" width="150" headerAlign="center" align ="center" allowSort="false" renderer="onDateRenderer">创建时间</div> 
            <div field="owner" width="80" headerAlign="center" align ="center" allowSort="false">所有者</div>    
    ...
    <script type="text/javascript">        
        ...
        function initForm() {
        	...
        	$.ajax({
                url: "<%=request.getContextPath() %>/srv/service/getMemcachedClusterDetail/" + clusterId,
        ...
        function goBack() {
        	window.location = "memcachedClusterMgr.jsp";
        }
        ...
        function removeService(serviceId) {
        	...
        	$.ajax({
				url: "<%=request.getContextPath() %>/srv/service/removeMemcachedService/" + serviceId,
                success: function (text) {
                	nui.unmask();
                	var o = nui.decode(text);
                	if (o.result == true) { 
