...
<body>
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/auth/addUser">
        <div style="padding-left:11px;padding-bottom:5px;">
            <table style="table-layout:fixed;" border="0">
                ...
                <tr>
                    ...
                    <td style="width:40%;">    
                         <input name="begin" id="begin" class="nui-textbox" required="true" width="60%" value="0.0.1.0"/>
                    </td>
                </tr>
                <tr>
                    <td style="width:10%;"  align="right">到：</td>
                    <td style="width:40%;">    
                         <input name="end" id="end" class="nui-textbox" required="true" width="60%" value="0.0.1.5"/>
                    </td> 
                </tr>
                <tr>
                    <td style="width:10%;"  align="right">子网掩码：</td>
                    <td style="width:20%;">    
                         <input name="netmask" id="netmask" class="nui-textbox" value="24" required="true" width="40%" vtype="range:0,32" rangeErrorText="数字必须在0~32之间"/> <span style="font-size:5px;">(注：十进制子网掩码 如：255.255.255.0-->24)</span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <script type="text/javascript">
	    ...
	    function saveData() {
	        ...
	        $.ajax({
	            url: "<%=request.getContextPath() %>/srv/vipMgr/addVIPSegment",
	            type: "post",
	            data: { keyData: json },
