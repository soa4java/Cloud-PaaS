...
<body>    
    ...
    <form id="form1" method="post">
    	...
    	<input id="parentMenuSeq" name="parentMenuSeq" class="nui-hidden"/>
        <div style="padding-left:11px;padding-bottom:5px;">
            <table style="table-layout:fixed;" border="0">
            	<tr>
            		<td style="width:10%;" align="right">父菜单：</td>
                    <td style="width:80%;">    
                         <input id="parentMenuName" name="parentMenuName" style="width:50%;" class="nui-textbox asLabel"/>
                    </td>
            	</tr>
                <tr>
                    <td style="width:10%;" align="right">菜单编码：</td>
                    <td style="width:80%;">    
                         <input name="menuCode" style="width:50%;" onvalidation="onMenuCodeValidation" class="nui-textbox"/><!--  <span id="menuCode_error" style="color:red"></span> -->
                    </td>
                </tr>
                <tr>
                    <td style="width:10%;" align="right">菜单名称：</td>
                    <td style="width:80%;">    
                         <input name="menuName" style="width:50%;" class="nui-textbox" required="true" />
                    </td>
                </tr>
                <tr>
                    <td style="width:10%;" align="right">图标样式：</td>
                    <td style="width:80%;">    
                         <input name="imagepath" style="width:50%;" class="nui-textbox" value="default"/>
                    </td>
                </tr>
                <tr>
                    <td style="width:10%;" align="right">链接资源：</td>
                    <td style="width:80%;">    
                         <input id="linkRes" name="linkRes" style="width:50%;" class="nui-buttonedit" required="true" onbuttonclick="onbuttonclick" allowInput="false"/>
                    </td>
                </tr>
                <tr>
    ...
    <script type="text/javascript">
        ...
        function SetData(data){
        	data = nui.clone(data);
        	//alert(data.parentNode.menuId);
        	//获取到父菜单信息
        	nui.get("parentMenuId").setValue(data.parentNode.menuId);
        	nui.get("parentMenuSeq").setValue(data.parentNode.menuSeq);
        	nui.get("parentMenuName").setValue(data.parentNode.menuName);
        }
        ...
        function saveData() {
            ...
            form.loading();
            $.ajax({
                url: "<%=request.getContextPath() %>/srv/authmenu/addCapMenu",
                type:"post",
                data: { keyData: json },
                success: function (text) {
				// form.unmask();
