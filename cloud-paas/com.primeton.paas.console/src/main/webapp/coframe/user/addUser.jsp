...
<body>    
    ...
    <form id="form1" method="post" action="<%=request.getContextPath() %>/srv/authuser/addUser">
    ...
    <script type="text/javascript">
        ...
        function saveData() {
            ...
            $.ajax({
                url: "<%=request.getContextPath() %>/srv/authuser/addUser",
                type: "post",
                data: { keyData: json },
                success: function (text) {
                	var o = nui.decode(text);
