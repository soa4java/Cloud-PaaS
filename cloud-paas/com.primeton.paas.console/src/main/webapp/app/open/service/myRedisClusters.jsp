	...
	<body style="height:100%">         
		<fieldset style="border:solid 1px #aaa;padding:3px;height:45%">
			...
			<div style="width:99%;">
				<div class="nui-toolbar" style="border-bottom:0;padding:0px;">
					<table style="width:100%;">
						<tr>
                    		<td style="width:100%;">
								<a class="nui-button" iconCls="icon-add" onclick="newRedis()">新建</a>
                    		</td>
                		</tr>
           			</table>           
        		</div>
			...
			<div id="datagrid" class="nui-datagrid" style="width:100%;height:90%;" allowResize="true"
					idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/myService/listRedis">
	    ...
	    function detailsRow(clusterId) {	
			window.location="redisServices.jsp?clusterId=" + clusterId;
        }
		...
		function newRedis() {
			nui.open({
                url: "<%=request.getContextPath() %>/app/open/service/createRedisService.jsp",
