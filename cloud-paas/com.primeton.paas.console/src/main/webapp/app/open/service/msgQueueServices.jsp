...
<body>
	<form id="form1" method="post" action="<%=request.getContextPath() %>/srv/service/getMsgQueueClusterDetail">
	...
	<div id="servicegrid" class="nui-datagrid" style="width:100%;height:120px" allowResize="true"
         idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/service/msgQueueService/<%=clusterId %>" showPager="false" onloaderror="onLoadErrorRenderer">
        <div property="columns">
            ...
            <div field="user" width="50" headerAlign="center" align ="center">用户名</div>      
    ...
    <script type="text/javascript">        
        ...
        function initForm() {
        	...
        	$.ajax({
                url: "<%=request.getContextPath() %>/srv/service/getMsgQueueClusterDetail/" + clusterId,
        ...
        function goBack() {
        	window.location = "myMsgQueueClusters.jsp";
        }
