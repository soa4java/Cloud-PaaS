...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="height:100%">         
		<fieldset style="border:solid 1px #aaa;padding:3px;height:45%">
			<legend ><b>平台应用关联服务</b></legend>	       		
	            <div id="datagridInnerHaproxy" class="nui-datagrid" style="width:100%;height:90%;" allowResize="true"
         					idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/myService/listHaproxy">
	       		...
	       		<div style="width:100%;">
			        <div class="nui-toolbar" style="border-bottom:0;padding:0px;">
			            <table style="width:100%;">
			                <tr>
			                    <td style="width:100%;">
			                        <a class="nui-button" iconCls="icon-add" onclick="createOuterHaproxy()">申请Haproxy服务</a>
			                        <a class="nui-button" iconCls="icon-remove" onclick="remove('datagridOuterHaproxy')">移除</a>       
			                    </td>
			                </tr>
			            </table>           
			        </div>
			</div>
			<div id="datagridOuterHaproxy" class="nui-datagrid" style="width:100%;height:80%;" allowResize="true"
         					idField="id" multiSelect="true" url="<%=request.getContextPath() %>/srv/myService/listOuterHaproxy" >
			        <div property="columns">
			            <div type="checkcolumn" ></div>        
			            <div field="id" width="60" headerAlign="center" align ="center" allowSort="true" renderer="onActionRendererOuterHaproxy">集群标识</div>    
			            <div field="name" width="200"  headerAlign="center" align ="center" allowSort="true">服务名称</div>    
			            <div field="attributes.size" width="80"  headerAlign="center" align ="center"  allowSort="true">集群实例数</div>  
			           <div header="实例数范围" headerAlign="center" align ="center" >
			                <div property="columns" headerAlign="center" align ="center">
    ...
    <script type="text/javascript">        
	    ...
	    var datagridInnerHaproxy = nui.get("datagridInnerHaproxy");
	    datagridInnerHaproxy.load();
	    
	    var datagridOuterHaproxy = nui.get("datagridOuterHaproxy");
	    datagridOuterHaproxy.load();
	   
        function createOuterHaproxy(){
	        nui.open({
	            url: "<%=request.getContextPath() %>/app/open/service/createOuterHaproxy.jsp",
	            title: "申请Haproxy服务", width: 800, height: 450,
	            onload: function () {
	            ...
	            ondestroy: function (action) {
	            	datagridOuterHaproxy.reload();
	            }
	        });
        }
        
        
        function onActionRendererOuterHaproxy(e) {
            var grid = e.sender;
            var record = e.record;
            var rowIndex = e.rowIndex;
            var id = record.id;
            var s = '<a href="javascript:openOuterHaproxy(\'' + id + '\')">' + id + '</a>';
            return s;
        }
