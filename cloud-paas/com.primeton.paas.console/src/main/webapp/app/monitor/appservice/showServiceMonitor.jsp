	...
	<table style="width:100%; height:100%;" border="0">
		<tr>
			...
			<td style="width:25%; height:5%;" colspan="1" align="right">
				...
				<a id="HaProxySetting" class="nui-button" onclick="doModify();">服务报警设置</a>
				<a id="refresh" class="nui-button" iconCls="icon-reload" onclick="refresh();"></a>&nbsp;
			</td>
		</tr>
		<tr>
			<td align="center" style="width:25%; height:90%;"><div id="cpuChartDiv" style="width:100%; height:80%;"></div>CPU使用率:&nbsp;<span id="cpuUsed"></span>%</td>
			<td align="center" style="width:25%; height:90%;"><div id="memChartDiv" style="width:100%; height:80%;"></div>内存使用率:&nbsp;<span id="memUsed"></span>%</td>
			<td valign="bottom">
				<table>
