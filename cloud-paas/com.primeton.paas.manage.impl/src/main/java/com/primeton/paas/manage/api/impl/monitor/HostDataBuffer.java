 ...
 *
 */
public class HostDataBuffer {
	
	private static ILogger logger = ManageLoggerFactory.getLogger(HostDataBuffer.class);
	...
	public synchronized static void start() {
		...
		thread.setName("WriteHostMonitorData");
	...
	private static class WriteData implements Runnable {
		...
		private HostMonitorDao dao = new DefaultHostMonitorDao();
