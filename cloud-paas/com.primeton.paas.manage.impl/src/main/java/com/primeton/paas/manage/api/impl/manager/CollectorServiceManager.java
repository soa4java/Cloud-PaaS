...
import com.primeton.paas.manage.api.manager.ICollectorServiceManager;
 ...
 *
 */
public class CollectorServiceManager extends DefaultServiceManager 
		implements ICollectorServiceManager {

	public static final String TYPE = CollectorService.TYPE;
	
	public CollectorServiceManager() {
		super();
	}
