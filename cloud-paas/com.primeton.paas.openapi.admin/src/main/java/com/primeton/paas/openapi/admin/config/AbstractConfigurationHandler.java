...
public abstract class AbstractConfigurationHandler<M extends IConfigModel> implements IConfigHandler<M> {
	...
	private static ILogger log = LoggerFactory.getLogger(AbstractConfigurationHandler.class);
	...
	/*
	 * (non-Javadoc)
	 * @see com.primeton.paas.openapi.admin.config.IConfigHandler#doLoad()
	 */
	public M doLoad() {
	...
	/*
	 * (non-Javadoc)
	 * @see com.primeton.paas.openapi.admin.config.IConfigHandler#deleteItems(com.primeton.paas.openapi.admin.config.IConfigModel, java.lang.String[])
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.primeton.paas.openapi.admin.config.IConfigHandler#updateModel(com.primeton.paas.openapi.admin.config.IConfigModel)
	 */
