 ...
 *
 */
public class AppMonitorEvent implements EventType, Constants {

	public static final String NAME = "appMonitorEvent";
	
	private static Map<String, Object> type = new HashMap<String, Object>();

	/* (non-Javadoc)
	 * @see com.primeton.paas.cep.model.EventType#getName()
	 */
	...
	public Map<String, Object> getType() {
		...
		if (type.isEmpty()) {
			// Common
			type.put(APP_NAME, String.class);
