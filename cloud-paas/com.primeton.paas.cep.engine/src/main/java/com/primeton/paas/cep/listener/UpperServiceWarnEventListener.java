 ...
 *
 */
public class UpperServiceWarnEventListener extends AbstractEventListener implements Constants {
	
	private static final String MSG_TYPE_KEY = "MSG_TYPE";
	private static final String MSG_TYPE_VALUE = "UPPER_SERVICE_MONITOR";
	
	private ServerContext context = ServerContext.getContext();
	private static final String EXCHANGE_NAME = "warnServiceMonitorExchange";
	private boolean isCreated = false;
	
	private static ILogger logger = LoggerFactory.getLogger(UpperServiceWarnEventListener.class);
	...
	public void update(EventBean[] newEvents, EventBean[] oldEvents) {
		...
		message.putHeader(CLUSTER_ID, clusterId);
