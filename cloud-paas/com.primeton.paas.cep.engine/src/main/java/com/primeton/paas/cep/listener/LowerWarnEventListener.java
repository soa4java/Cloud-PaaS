 ...
 *
 */
public class LowerWarnEventListener extends AbstractEventListener implements Constants {
	
	private static final String MSG_TYPE_KEY = "MSG_TYPE";
	private static final String MSG_TYPE_VALUE = "LOWER_APP_MONITOR";
	private static final String ACTION_KEY = "EVENT_ACTION";
	private static final String ACTION_VALUE = "DECREASE";
